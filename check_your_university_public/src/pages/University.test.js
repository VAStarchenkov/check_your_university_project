...
const testUniversity = {
    ...
    description:
      'Очень большой корпус из 13 зданий, в котором есть несколько кофеен, столовая, круглосуточная четырехэтажная библиотека, медкабинет, спортзал и пространства коворкингов (переговорная, зрительный зал, тихая зона для индивидуальной работы, места для обсуждения групповых проектов) и много-много разнообразных аудиторий. Само здание многоэтажное и большое, его открыли в 2019. Сейчас — это центр жизни ВШЭ, место проведения большого количества университетских мероприятий.  Здесь находятся факультеты экономических наук, компьютерных наук, географии, МИЭФ, совместной программы ВШЭ и РЭШ.',
